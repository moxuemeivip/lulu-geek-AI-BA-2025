...
data = {
    'age_group': ['18-30', '18-30', '18-30', '18-30', '18-30', 
                  ...
                  '61+', '61+', '61+', '61+', '61+'],
    'renewal': [0, 0, 1, 1, 1,  # 18-30: 2No, 3Yes
                0, 1, 1, 1, 1,  # 31-45: 1No, 4Yes
                1, 1, 1, 1, 1,  # 46-60: 0No, 5Yes
                0, 0, 0, 1, 1]  # 61+: 3No, 2Yes
}
...
print("\n=== 评分卡模型中的应用 ===")
print("1. WOE用于将原始变量转换为线性可分的数值")
print("2. IV用于特征筛选，通常选择IV≥0.02的特征")
print("3. WOE值越大，表示该分箱中坏客户比例越高")
print("4. WOE值越小，表示该分箱中好客户比例越高")